...
function WorkSection({ workList, ...other }: WorkSectionProps) {

  const [currentIndex, setCurrentIndex] = useState(-1);

  function setThisAsCurrentIndex(a: number) {
    if (currentIndex != a) setCurrentIndex(a);
      ...
      <div className="my-works-item-container">
        ...
        {linkTo && (
          <div className="link-container">
            <div className="link">
              <a href={linkTo}>{linkText || "files"}</a>
            </div>
          </div>
        )}
      </div>
